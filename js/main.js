jQuery(document).ready(function($) {
    ...
    checkbox.addEventListener('change', function () {
        //s
        document.getElementById("s1").textContent = "BASIC WASH";
        document.getElementById("s2").textContent = "BASIC INTERIOR CLEANING";
        document.getElementById("s3").textContent = "FULL WASH";
        document.getElementById("s4").textContent = "BASIC WASH";
        //l1
        document.getElementById("l11").textContent = "High preasure foam window";
        document.getElementById("l12").textContent = "tyre & Wheel Cleaning";
        document.getElementById("l13").textContent = "Mat Cleaning";
        document.getElementById("l14").textContent = "Engine and glass cleaning";
        //l2
        document.getElementById("l21").textContent = "Vacuuming";
        document.getElementById("l22").textContent = "Dashboard Cleaning";
        document.getElementById("l23").textContent = "Mat Cleaning";
        document.getElementById("l24").textContent = "";
        //l3
        document.getElementById("l31").textContent = "BASIC WASH";
        document.getElementById("l32").textContent = "&";
        document.getElementById("l33").textContent = "BASIC INTERIOR CLEANING";
        document.getElementById("l34").textContent = "Under body cleaning";
        //l4
        document.getElementById("l41").textContent = "High preasure foam window";
        document.getElementById("l42").textContent = "tyre & Wheel Cleaning";
        document.getElementById("l43").textContent = "Mat Cleaning";
        document.getElementById("l44").textContent = "Engine and glass cleaning";

        document.getElementById("selector").style.visibility = "visible";
        document.getElementById("selector1").style.visibility = "hidden";
        document.getElementById("salary").textContent = "/Monthly";
    ...
    checkbox1.addEventListener('change', function () {
        ...
        document.getElementById("s4").textContent = "Front Glass";
        //l1
        document.getElementById("l11").textContent = "3M";
        document.getElementById("l12").textContent = "Take and return the car for free";
        document.getElementById("l13").textContent = "";
        document.getElementById("l14").textContent = "";
        //l2
        document.getElementById("l21").textContent = "3M";
        document.getElementById("l22").textContent = "Take and return the car for free";
        document.getElementById("l23").textContent = "";
        document.getElementById("l24").textContent = "";
        //l3
        document.getElementById("l31").textContent = "3M";
        document.getElementById("l32").textContent = "Take and return the car for free";
        document.getElementById("l33").textContent = "";
        document.getElementById("l34").textContent = "";
        //l4
        document.getElementById("l41").textContent = "Take and return the car for free ";
        ...
        document.getElementById("salary").textContent = "SAR";
